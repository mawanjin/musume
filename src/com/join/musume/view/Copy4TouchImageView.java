 ...
 * Time: 5:13 PM
 */
public class Copy4TouchImageView extends ImageView {
    ...
    public Copy4TouchImageView(TouchImageViewActivity activity) {
        super(activity);
...
//                    matrixCheck = matrixCheck();
    ...
    private void resetOnclick() {
        ...
        for (Pointer pointer1 : viewItems) {
//            pointer1.leftTopX = pointer1.scaledX + offsetX;
//            pointer1.leftTopY = pointer1.scaledY + offsetY;
...
//                pointer1.width = (pointer1.originWidth)+(pointer1.originWidth)*(scale - 1);
//                pointer1.height = (pointer1.originHeight)+(pointer1.originHeight)*(scale - 1);
...
//                pointer1.width = (pointer1.originWidth)-(pointer1.originWidth)*(1 - scale);
//                pointer1.height = (pointer1.originHeight)-(pointer1.originHeight)*(1 - scale);
            }
